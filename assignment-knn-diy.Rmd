...
train_label <- cleand2[1:7000, 1]
test_label <- cleand2[7000:8143, 1]
```


## Modeling

I will change the names used for describing the vector to 'occupancy', since this was the original name of the data set.
...
The model is created, and will be evaluated by running the prediction against the test data set, using the table command.

```{r}

table(Occupancy_pred, test_label) 
